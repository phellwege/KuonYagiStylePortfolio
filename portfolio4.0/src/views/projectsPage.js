                                ...
                                <div className='innerDiv'>
                                    <div className='projectLeft'>
                                        ...
                                        <div className='projectImgDiv'>
                                            <a href='https://resumancy.com' target='_blank' rel="noreferrer">
                                    ...
                                    <div className='projectRight'>
                                        ...
                                        <div className='projectLinks'>
                                            <a href='https://resumancy.com' target='_blank' rel="noreferrer">Deployed Site</a>
                                        </div>
                                    </div>
                                    <br/>
                            ...
                            <div className='projectWrap'>
                                <div className='innerDiv'>
                                    <div className='projectLeft'>
                                        ...
                                        <br/>
                                        <div className='projectImgDiv'>
                                            <a href='https://phellwege.github.io/ecommerce-product-page-component/' target='_blank' rel="noreferrer">
                                    ...
                                    <div className='projectRight'>
                                        ...
                                        <div className='projectLinks'>
                                            ...
                                            <a href='https://github.com/phellwege/ecommerce-product-page-component' target='_blank' rel="noreferrer">Github Repo</a>
                                        </div>
                                    </div>
                                    <br/>
                                    <h2 className='ProjectNumbers'>
                                ...
                                <div className='innerDiv'>
                                    <div className='projectLeft'>
                                        ...
                                        <div className='projectImgDiv'>
                                            ...
                                            <a href='https://phellwege.github.io/RockPaperScissors/' target='_blank' rel="noreferrer">
                                    ...
                                    <div className='projectRight'>
                                        ...
                                        <div className='projectLinks'>
                                            ...
                                            <a href='https://github.com/phellwege/RockPaperScissors' target='_blank' rel="noreferrer">Github Repo</a>
                                        </div>
                                    </div>
                                    <br/>
                                    <h2 className='ProjectNumbers'>
                                ...
                                <div className='innerDiv'>
                                    <div className='projectLeft'>
                                        ...
                                        <div className='projectImgDiv'>
                                            ...
                                            <a href='https://phellwege.github.io/SpaceTourism/' target='_blank' rel="noreferrer">
                                    ...
                                    <div className='projectRight'>
                                        ...
                                        <div className='projectLinks'>
                                            ...
                                            <a href='https://github.com/phellwege/SpaceTourism' target='_blank' rel="noreferrer">Github Repo</a>
                                        </div>
                                    </div>
                                    <br/>
                                    <h2 className='ProjectNumbers'>
                            ...
                            <div className='projectWrap'>
                                <div className='innerDiv'>
                                    <div className='projectLeft'>
                                        ...
                                        <br/>
                                        <div className='projectImgDiv'>
                                            <a href='https://phellwege.github.io/ThePartyTime/' target='_blank' rel="noreferrer">
                                    ...
                                    <div className='projectRight'>
                                        ...
                                        <div className='projectLinks'>
                                            ...
                                            <a href='https://github.com/phellwege/ThePartyTime' target='_blank' rel="noreferrer">Github Repo</a>
                                        </div>
                                    </div>
                                    <br/>
                                    <h2 className='ProjectNumbers'>
                            ...
                            <div className='projectWrap'>
                                <div className='innerDiv'>
                                    <div className='projectLeft'>
                                        ...
                                        <br/>
                                        <div className='projectImgDiv'>
                                            <a href='https://phellwege.github.io/countdown/' target='_blank' rel="noreferrer">
                                    ...
                                    <div className='projectRight'>
                                        ...
                                        <div className='projectLinks'>
                                            ...
                                            <a href='https://github.com/phellwege/countdown' target='_blank' rel="noreferrer">Github Repo</a>
                                        </div>
                                    </div>
                                    <br/>
                                    <h2 className='ProjectNumbers'>
                            ...
                            <div className='projectWrap'>
                                <div className='innerDiv'>
                                    <div className='projectLeft'>
                                        ...
                                        <br/>
                                        <div className='projectImgDiv'>
                                            <a href='http://ec2-3-14-141-156.us-east-2.compute.amazonaws.com/' target='_blank' rel="noreferrer">
                                    ...
                                    <div className='projectRight'>
                                        ...
                                        <div className='projectLinks'>
                                            ...
                                            <a href='https://github.com/bdsullivan123/homecoming' target='_blank' rel="noreferrer">Github Repo</a>
                                        </div>
                                    </div>
                                    <br/>
                                    <h2 className='ProjectNumbers'>
                                ...
                                <div className='innerDiv'>
                                    ...
                                    <div className='projectRight'>
                                        ...
                                        <div className='projectLinks'>
                                            ...
                                            <a href='https://github.com/phellwege/Tip_Calculator' target='_blank' rel="noreferrer">Github Repo</a>
                                        </div>
                                    </div>
                                    <br/>
                                    <h2 className='ProjectNumbers'>
